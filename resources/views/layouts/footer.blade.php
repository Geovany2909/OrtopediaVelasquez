    ...
    <section class="footer">
        ...
        <div>
            ...
            <ul>
                ...
                <li><a href="#"><img src="{{ asset('inicio/img/facebook.png') }}" alt=""></a></li>
                <li><a href="#"><img src="{{ asset('inicio/img/twitter.png') }}"alt=""></a></li>
                <li><a href="#"><img src="{{ asset('inicio/img/instagram.png') }}" alt=""></a></li>
            </ul>
        </div>
    </section>
    <div class="fot">
